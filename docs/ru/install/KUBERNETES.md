**English:** [docs/install/KUBERNETES.md](../../install/KUBERNETES.md)

Развёртывание в Kubernetes через Helm chart [`deploy/helm/demo/`](../../../deploy/helm/demo/).  
Конфигурация приложения: [CONFIGURATION.md](../CONFIGURATION.md) · checklist: [PRODUCTION_DEPLOY.md](../../PRODUCTION_DEPLOY.md).
