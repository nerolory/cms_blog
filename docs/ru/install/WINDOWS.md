**English:** [docs/install/WINDOWS.md](../../install/WINDOWS.md)

Развёртывание на Windows: Docker Desktop (рекомендуется), WSL2, Laragon или standalone PHP.  
...
Самый предсказуемый путь на Windows — тот же stack, что в CI/Linux.
